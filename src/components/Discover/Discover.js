...
import { setMovies, setPage, setMoviesSummary, setAnimations, setAnimationsPage } from '../../store/discover'
import { setGenres } from '../../store/genre'
import MovieCarousel from '../moviecarousel/MovieCarousel'
import Category from '../category/Category'
import useAxios from '../../hooks/useAxios'
import ColumnStack from '../ui/ColumnStack'
import { getTrendingUrl, getAnimationsUrl, movieGenresUrl, tvGenresUrl } from '../../utils/requests/endpoints'
