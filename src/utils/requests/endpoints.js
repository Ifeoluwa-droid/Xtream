...
export const getTopKidMoviesUrl = (currentPage) => `${TMDBDOMAIN}/discover/movie?api_key=${process.env.REACT_APP_TMDB_API_KEY}&language=en-US&certification_country=US&certification.lte=G&sort_by=popularity.desc&primary_release_year=2022&page=${currentPage}`
